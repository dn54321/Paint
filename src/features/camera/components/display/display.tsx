...
import { CameraActions } from "../../types/camera-action-subscriber.types";
...
export function Display(props: DisplayProps) {
  ...
  const recordScrollDebounce = useDebouncedCallback((camera: Camera) => camera.updateState(), 250);
  ...
  useEffect(() => {
    ...
    if (props.camera.getActiveCanvas()) {
