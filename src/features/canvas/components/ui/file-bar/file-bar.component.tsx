...
export interface FilebarProps {
    ...
    active?: CanvasFile,
    onClick?: (file: CanvasFile) => void,
    onClose?: (file: CanvasFile) => void,
    onMove?: (file: CanvasFile, position: number) => void,
}
...
export function Filebar(props: FilebarProps) {
    ...
    const fileMap = props.files.reduce<Record<string, CanvasFile>>(
